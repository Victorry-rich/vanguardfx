...
def send_confirmation_email(request, user):
    ...
    confirmation_link = f'https://cryptovest.online/confirm-email/{token}/'
    email_data = {
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              ...
              <img src="https://cryptovest.online/static/logo/logo-7.png" style="border-radius: 15px;" height="200"/>
                </td>
            </tr>
            ...
            <tr>
              ...
              Thanks for signing up for <span class="il">Cryptovest! </span><br> We're so excited to have you onboard.</td>
            </tr>
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
            ...
            <tr>
              <td valign="top" align="center" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:10px 40px 40px 40px">
                <a href="https://cryptovest.online">cryptovest.online</a></td>
            </tr>
...
def reset_password(request, user):
    ...
    # Compose the email message
    recipient = user.email
    reset_link = f'https://cryptovest.online/reset-password/{token}/'
    email_data = {
                "from": "Cryptovest <noreply@cryptovest.online>",
                "to": recipient,
        ...
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            ...
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
              You requested a password reset on your<br> Cryptovest account.</td>
            </tr>
            <tr>
              <td valign="top" align="left" style="font-family:Roboto,Helvetica,Arial sans-serif;font-size:14px;line-height:24px;color:#414347;padding:40px 40px 20px 40px">
